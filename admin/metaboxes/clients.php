...
class AngoraClients {
	...
	public static function init( ) {
		if ( class_exists( 'AngoraAdmin' ) ) {
			AngoraAdmin::addMetaBox('clients');
		}
	}
	...
	public static function content( $post ) {
		...
		$output = '<p><strong>' . esc_html__( 'Website URL', 'angora' ) . '</strong></p>
...
if ( class_exists( 'AngoraAdmin' ) ) {
	AngoraAdmin::addAction('clients');
}

add_action( 'save_post', array( 'AngoraClients', 'save' ) );
